...
@tbe_register.register_operator("GridSampler2dV2Grad", trans_bool_to_s8=False)
...
def grid_sampler2d_v2_grad(grad_in__, x_in__, grid_in__, dx_out_, dgrid_out_, interpolation_mode, padding_mode, align_corners, kernel_name="grid_sampler2d_v2_grad", impl_mode=""):
    ...
    origin_func_name = "grid_sampler2d_v2_grad"
    ascendc_src_dir_ex = "grid_sampler2d_v2_grad"
    ascendc_src_dir = "grid_sampler2d_v2_grad"
    ascendc_src_file = "grid_sampler2d_v2_grad.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    print("start compile Ascend C operator GridSampler2dV2Grad. kernel name is " + kernel_name)
    op_type = "GridSampler2dV2Grad"
...
def op_select_format(grad_in__, x_in__, grid_in__, dx_out_, dgrid_out_, interpolation_mode, padding_mode, align_corners, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(grad_in__, x_in__, grid_in__, dx_out_, dgrid_out_, interpolation_mode, padding_mode, align_corners)
    result = check_op_cap("op_select_format", "GridSampler2dV2Grad", __inputs__, __outputs__, __attrs__)
...
def get_op_specific_info(grad_in__, x_in__, grid_in__, dx_out_, dgrid_out_, interpolation_mode, padding_mode, align_corners, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(grad_in__, x_in__, grid_in__, dx_out_, dgrid_out_, interpolation_mode, padding_mode, align_corners)
    result = check_op_cap("get_op_specific_info", "GridSampler2dV2Grad", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
