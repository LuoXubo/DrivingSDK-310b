...
@tbe_register.register_operator("SubmSparseConv3dGrad", trans_bool_to_s8=False)
...
def subm_sparse_conv3d_grad(outidx_offset_in__, valid_indices_in__, grad_out_features_in__, grad_out_features_iml2col_out_, kernel_size, in_channel, kernel_name="subm_sparse_conv3d_grad", impl_mode=""):
    ...
    origin_func_name = "subm_sparse_conv3d_grad"
    ascendc_src_dir_ex = "subm_sparse_conv3d_grad"
    ascendc_src_dir = "subm_sparse_conv3d_grad"
    ascendc_src_file = "subm_sparse_conv3d_grad.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    print("start compile Ascend C operator SubmSparseConv3dGrad. kernel name is " + kernel_name)
    op_type = "SubmSparseConv3dGrad"
...
def op_select_format(outidx_offset_in__, valid_indices_in__, grad_out_features_in__, grad_out_features_iml2col_out_, kernel_size, in_channel, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(outidx_offset_in__, valid_indices_in__, grad_out_features_in__, grad_out_features_iml2col_out_, kernel_size, in_channel)
    result = check_op_cap("op_select_format", "SubmSparseConv3dGrad", __inputs__, __outputs__, __attrs__)
...
def get_op_specific_info(outidx_offset_in__, valid_indices_in__, grad_out_features_in__, grad_out_features_iml2col_out_, kernel_size, in_channel, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(outidx_offset_in__, valid_indices_in__, grad_out_features_in__, grad_out_features_iml2col_out_, kernel_size, in_channel)
    result = check_op_cap("get_op_specific_info", "SubmSparseConv3dGrad", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
