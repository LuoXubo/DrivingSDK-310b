...
@tbe_register.register_operator("PointsInBox", trans_bool_to_s8=False)
...
def points_in_box(boxes_in__, pts_in__, boxes_idx_of_points_out_, kernel_name="points_in_box", impl_mode=""):
    ...
    origin_func_name = "points_in_box"
    ascendc_src_dir_ex = "points_in_box"
    ascendc_src_dir = "points_in_box"
    ascendc_src_file = "points_in_box.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    print("start compile Ascend C operator PointsInBox. kernel name is " + kernel_name)
    op_type = "PointsInBox"
...
def op_select_format(boxes_in__, pts_in__, boxes_idx_of_points_out_, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(boxes_in__, pts_in__, boxes_idx_of_points_out_)
    result = check_op_cap("op_select_format", "PointsInBox", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def get_op_specific_info(boxes_in__, pts_in__, boxes_idx_of_points_out_, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(boxes_in__, pts_in__, boxes_idx_of_points_out_)
    result = check_op_cap("get_op_specific_info", "PointsInBox", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
