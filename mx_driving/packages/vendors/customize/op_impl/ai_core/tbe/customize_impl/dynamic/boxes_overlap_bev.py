...
@tbe_register.register_operator("BoxesOverlapBev", trans_bool_to_s8=False)
...
def boxes_overlap_bev(boxes_a_in__, boxes_b_in__, res_out_, format_flag=1, clockwise=True, mode_flag=0, aligned=False, margin=1e-05, kernel_name="boxes_overlap_bev", impl_mode=""):
    ...
    origin_func_name = "boxes_overlap_bev"
    ascendc_src_dir_ex = "boxes_overlap_bev"
    ascendc_src_dir = "boxes_overlap_bev"
    ascendc_src_file = "boxes_overlap_bev.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    print("start compile Ascend C operator BoxesOverlapBev. kernel name is " + kernel_name)
    op_type = "BoxesOverlapBev"
...
def op_select_format(boxes_a_in__, boxes_b_in__, res_out_, format_flag=1, clockwise=True, mode_flag=0, aligned=False, margin=1e-05, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(boxes_a_in__, boxes_b_in__, res_out_, format_flag, clockwise, mode_flag, aligned, margin)
    result = check_op_cap("op_select_format", "BoxesOverlapBev", __inputs__, __outputs__, __attrs__)
...
def get_op_specific_info(boxes_a_in__, boxes_b_in__, res_out_, format_flag=1, clockwise=True, mode_flag=0, aligned=False, margin=1e-05, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(boxes_a_in__, boxes_b_in__, res_out_, format_flag, clockwise, mode_flag, aligned, margin)
    result = check_op_cap("get_op_specific_info", "BoxesOverlapBev", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
