...
@tbe_register.register_operator("ScatterMaxV1", trans_bool_to_s8=False)
...
def scatter_max_v1(src_in__, index_in__, res_out_, argmax_out_, kernel_name="scatter_max_v1", impl_mode=""):
    ...
    origin_func_name = "scatter_max_v1"
    ascendc_src_dir_ex = "scatter_max_v1"
    ascendc_src_dir = "scatter_max_v1"
    ascendc_src_file = "scatter_max_v1.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    print("start compile Ascend C operator ScatterMaxV1. kernel name is " + kernel_name)
    op_type = "ScatterMaxV1"
...
def op_select_format(src_in__, index_in__, res_out_, argmax_out_, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(src_in__, index_in__, res_out_, argmax_out_)
    result = check_op_cap("op_select_format", "ScatterMaxV1", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def get_op_specific_info(src_in__, index_in__, res_out_, argmax_out_, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(src_in__, index_in__, res_out_, argmax_out_)
    result = check_op_cap("get_op_specific_info", "ScatterMaxV1", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
