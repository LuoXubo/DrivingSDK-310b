...
def _build_args(x_in__, weight_in__, bias_in__, offset_in__, mask_in__, y_out_, offset_output_out_, kernel_size, stride, padding, dilation, groups, deformable_groups, modulated, with_bias):
    __inputs__ = []
    for arg in [x_in__, weight_in__, bias_in__, offset_in__, mask_in__]:
        if arg != None:
...
@tbe_register.register_operator("DeformableConv2d", trans_bool_to_s8=False)
...
def deformable_conv2d(x_in__, weight_in__, bias_in__=None, offset_in__=None, mask_in__=None, y_out_=None, offset_output_out_=None, kernel_size=[], stride=[], padding=[], dilation=[], groups=0, deformable_groups=0, modulated=False, with_bias=False, kernel_name="deformable_conv2d", impl_mode=""):
    if get_current_build_config("enable_op_prebuild"):
        return
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, weight_in__, bias_in__, offset_in__, mask_in__, y_out_, offset_output_out_, kernel_size, stride, padding, dilation, groups, deformable_groups, modulated, with_bias)
    ...
    origin_func_name = "deformable_conv2d"
    ascendc_src_dir_ex = "deformable_conv2d"
    ascendc_src_dir = "deformable_conv2d"
    ascendc_src_file = "deformable_conv2d.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    print("start compile Ascend C operator DeformableConv2d. kernel name is " + kernel_name)
    ...
    op_info = OpInfo(kernel_name = kernel_name, op_type = op_type, inputs = __inputs__, outputs = __outputs__,\
        attrs = __attrs__, impl_mode = impl_mode, origin_inputs=[x_in__, weight_in__, bias_in__, offset_in__, mask_in__], origin_outputs = [y_out_, offset_output_out_])
    compile_op(src, origin_func_name, op_info, options, code_channel, '{}')

def op_select_format(x_in__, weight_in__, bias_in__=None, offset_in__=None, mask_in__=None, y_out_=None, offset_output_out_=None, kernel_size=[], stride=[], padding=[], dilation=[], groups=0, deformable_groups=0, modulated=False, with_bias=False, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, weight_in__, bias_in__, offset_in__, mask_in__, y_out_, offset_output_out_, kernel_size, stride, padding, dilation, groups, deformable_groups, modulated, with_bias)
    result = check_op_cap("op_select_format", "DeformableConv2d", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def get_op_specific_info(x_in__, weight_in__, bias_in__=None, offset_in__=None, mask_in__=None, y_out_=None, offset_output_out_=None, kernel_size=[], stride=[], padding=[], dilation=[], groups=0, deformable_groups=0, modulated=False, with_bias=False, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, weight_in__, bias_in__, offset_in__, mask_in__, y_out_, offset_output_out_, kernel_size, stride, padding, dilation, groups, deformable_groups, modulated, with_bias)
    result = check_op_cap("get_op_specific_info", "DeformableConv2d", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
