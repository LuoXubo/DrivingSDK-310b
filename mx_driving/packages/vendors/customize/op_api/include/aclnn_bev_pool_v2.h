...
#ifndef ACLNN_BEVPOOL_V2_H_
#define ACLNN_BEVPOOL_V2_H_
...
/* funtion: aclnnBEVPoolV2GetWorkspaceSize
 * parameters :
 * depth : required
 * feat : required
 * ranksDepth : required
...
aclnnStatus aclnnBEVPoolV2GetWorkspaceSize(
